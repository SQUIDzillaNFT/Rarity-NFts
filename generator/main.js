...
const serverUrl = "https://jwfpqrmbwend.usemoralis.com:2053/server"; //Moralis Server Url here
const appId = "MJyraJnM4RYdqxpNgCxZnDccokMQ8xalsCiPKTYU"; //Moralis Server App ID here
